...
assert(result1.bundle.meaning.bundle_ref === result2.bundle.meaning.bundle_ref, "Determinism failed: identical inputs produced different bundle_ref");
...
assert(result1.bundle.meaning.bundle_ref !== result3.bundle.meaning.bundle_ref, "Hash sensitivity failed: modified input produced same bundle_ref");
