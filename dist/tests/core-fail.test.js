...
assert(coreValidation.valid === false && !!coreValidation.errors?.length, "Expected core schema validation to fail with errors");
console.log("Core fail test passed.");
//# sourceMappingURL=core-fail.test.js.map