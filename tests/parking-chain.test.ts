...
assert(
  result1.bundle.meaning.aggregated_state === "valid",
  "Step 1 aggregated_state must be valid",
);
...
assert(
  result2.bundle.meaning.aggregated_state === "valid",
  "Step 2 aggregated_state must be valid",
);
assert(
  result2.bundle.meaning.derived_from.includes(result1.bundle.meaning.bundle_ref),
  "Step 2 derived_from must include previous bundle_ref",
);
...
assert(
  result3.bundle.meaning.aggregated_state === "hold",
  "Step 3 aggregated_state must be hold",
);
assert(
  result3.bundle.meaning.derived_from.includes(result2.bundle.meaning.bundle_ref),
  "Step 3 derived_from must include previous bundle_ref",
);
...
assert(
  result4.bundle.meaning.aggregated_state === "valid",
  "Step 4 aggregated_state must be valid",
);
assert(
  result4.bundle.meaning.derived_from.includes(result3.bundle.meaning.bundle_ref),
  "Step 4 derived_from must include previous bundle_ref",
);
